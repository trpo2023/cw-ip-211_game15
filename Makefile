...
LOGIC_SOURCES = $(SRC_DIR)/$(APP_NAME)/$(LOGIC_NAME).$(CPP_EXT)
LOGIC_HPP = $(SRC_DIR)/$(APP_NAME)/$(LOGIC_NAME).$(HPP_EXT)
LOGIC_OBJECTS = $(OBJ_DIR)/$(SRC_DIR)/$(LOGIC_NAME)/$(LOGIC_NAME).o

GRAPH_SOURCES = $(SRC_DIR)/$(APP_NAME)/$(GRAPH_NAME).$(CPP_EXT)
GRAPH_HPP = $(SRC_DIR)/$(APP_NAME)/$(GRAPH_NAME).$(HPP_EXT)
